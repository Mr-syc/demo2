    ...
    <div class="header-top container-fuild hidden-xs">
      <div class="container">
        <div class="server pull-left">
          ...
          <span class="glyphicon glyphicon-envelope"></span>123456789@gmail.com
...
#header .header-nav .header-nav-m-name{
  color: black;
  height: 100%;
  wigth: 200px;
  position: relative;
